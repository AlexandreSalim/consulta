...
export const requiredAddressValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
    ...
    const controlsToCheck = Object.keys(addressGroup.controls).filter((controlKey) => controlKey !== 'type' && controlKey !== 'typeDescripitions')
...
const hasText = (control: AbstractControl | null) => {
